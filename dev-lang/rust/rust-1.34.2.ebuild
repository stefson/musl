...
PATCHES=(
	...
	"${FILESDIR}/${PV}/0007-runtest-Fix-proc-macro-tests-on-musl-hosts.patch"
	"${FILESDIR}/${PV}/0008-Correct-minimum-system-LLVM-version-in-tests.patch"
	...
	"${FILESDIR}/${PV}/0030-liblibc-linkage.patch"
	"${FILESDIR}/${PV}/0040-rls-atomics.patch"
	"${FILESDIR}/${PV}/0050-llvm.patch"
	"${FILESDIR}/${PV}/0051-llvm-D45520.patch"
	"${FILESDIR}/${PV}/0052-llvm-D52013.patch"
	"${FILESDIR}/${PV}/0053-llvm-secureplt.patch"
	"${FILESDIR}/${PV}/0060-fix-build-with-libressl-2.9.1.patch"
)
