...
PATCHES=(
	"${FILESDIR}/${P}/0001-Don-t-pass-CFLAGS-to-the-C-compiler.patch"
	"${FILESDIR}/${P}/0002-Fix-LLVM-build.patch"
	"${FILESDIR}/${P}/0003-Allow-rustdoc-to-work-when-cross-compiling-on-musl.patch"
	"${FILESDIR}/${P}/0004-Require-static-native-libraries-when-linking-static-.patch"
	"${FILESDIR}/${P}/0005-Remove-nostdlib-and-musl_root-from-musl-targets.patch"
	"${FILESDIR}/${P}/0006-Prefer-libgcc_eh-over-libunwind-for-musl.patch"
	"${FILESDIR}/${P}/0007-runtest-Fix-proc-macro-tests-on-musl-hosts.patch"
	"${FILESDIR}/${P}/0008-Correct-minimum-system-LLVM-version-in-tests.patch"
	"${FILESDIR}/${P}/0009-test-use-extern-for-plugins-Don-t-assume-multilib.patch"
	"${FILESDIR}/${P}/0010-test-sysroot-crates-are-unstable-Fix-test-when-rpath.patch"
	"${FILESDIR}/${P}/0011-Ignore-broken-and-non-applicable-tests.patch"
	"${FILESDIR}/${P}/0012-Link-stage-2-tools-dynamically-to-libstd.patch"
	"${FILESDIR}/${P}/0013-Move-debugger-scripts-to-usr-share-rust.patch"
	"${FILESDIR}/${P}/0014-Add-gentoo-target-specs.patch"
	"${FILESDIR}/${P}/0030-liblibc-linkage.patch"
	"${FILESDIR}/${P}/0040-rls-atomics.patch"
	"${FILESDIR}/${P}/0050-llvm.patch"
	"${FILESDIR}/${P}/0051-llvm-D45520.patch"
	"${FILESDIR}/${P}/0052-llvm-D52013.patch"
	"${FILESDIR}/${P}/0053-llvm-secureplt.patch"
	"${FILESDIR}/${P}/0060-fix-build-with-libressl-2.9.1.patch"
)
