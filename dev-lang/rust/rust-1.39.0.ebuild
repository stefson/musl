...
PATCHES=(
	"${FILESDIR}/1.39.0-pr65474.patch"
	"${FILESDIR}/rust-1.39.0/0001-Don-t-pass-CFLAGS-to-the-C-compiler.patch"
	"${FILESDIR}/rust-1.39.0/0002-Fix-LLVM-build.patch"
	"${FILESDIR}/rust-1.39.0/0003-Allow-rustdoc-to-work-when-cross-compiling-on-musl.patch"
	"${FILESDIR}/rust-1.39.0/0004-Require-static-native-libraries-when-linking-static-.patch"
	"${FILESDIR}/rust-1.39.0/0005-Remove-nostdlib-and-musl_root-from-musl-targets.patch"
	"${FILESDIR}/rust-1.39.0/0006-Prefer-libgcc_eh-over-libunwind-for-musl.patch"
	"${FILESDIR}/rust-1.39.0/0007-Add-target-thumbv7neon-unknown-linux-musleabihf.patch"
	"${FILESDIR}/rust-1.39.0/0008-Configure-LLVM-module-PIC-level.patch"
	"${FILESDIR}/rust-1.39.0/0009-Fix-C-aggregate-passing-ABI-on-powerpc.patch"
	"${FILESDIR}/rust-1.39.0/0010-Fix-zero-sized-aggregate-ABI-on-powerpc.patch"
	"${FILESDIR}/rust-1.39.0/0011-Link-libssp_nonshared.a-on-all-musl-targets.patch"
	"${FILESDIR}/rust-1.39.0/0012-Use-rustc-workspace-hack-for-rustbook.patch"
	"${FILESDIR}/rust-1.39.0/0013-test-failed-doctest-output-Fix-normalization.patch"
	"${FILESDIR}/rust-1.39.0/0014-test-use-extern-for-plugins-Don-t-assume-multilib.patch"
	"${FILESDIR}/rust-1.39.0/0015-test-sysroot-crates-are-unstable-Fix-test-when-rpath.patch"
	"${FILESDIR}/rust-1.39.0/0016-Ignore-broken-and-non-applicable-tests.patch"
	"${FILESDIR}/rust-1.39.0/0017-Link-stage-2-tools-dynamically-to-libstd.patch"
	"${FILESDIR}/rust-1.39.0/0018-Move-debugger-scripts-to-usr-share-rust.patch"
	"${FILESDIR}/rust-1.39.0/0019-Add-gentoo-target-specs.patch"
	"${FILESDIR}/rust-1.39.0/0030-libc-linkage.patch"
	"${FILESDIR}/rust-1.39.0/0031-typenum-pmmx.patch"
	"${FILESDIR}/rust-1.39.0/0032-libgit2-sys-abi.patch"
	"${FILESDIR}/rust-1.39.0/0040-rls-atomics.patch"
	"${FILESDIR}/rust-1.39.0/0050-llvm.patch"
	"${FILESDIR}/rust-1.39.0/0051-llvm-powerpc-plt.patch"
	"${FILESDIR}/rust-1.39.0/0052-llvm-powerpc-elfv2.patch"
	"${FILESDIR}/rust-1.39.0/0060-Update-libressl-support-3.x.patch"
)
